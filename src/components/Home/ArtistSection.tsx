...
const checklist = [
	"Earn up to $0.15 per stream — the highest in the industry",
			...
			<div className="relative">
				<div className="relative ml-auto h-full max-w-[1740px] text-white">
					...
					<div className="lg:absolute top-0 z-50 px-[20px] lg:px-0">
						<div className="relative inline-block   w-[259px] rounded-md md:w-auto px-2 lg:px-6 py-2 lg:py-4 text-white text-[20px] lg:text-[50px] font-[Orbitron] font-normal overflow-hidden">
							<span className="relative z-10 font-bold uppercase">
								Artist: Why <br className="lg:hidden" /> Music Exclusive?
							</span>
					...
					<div className="lg:pt-[250px] flex h-full w-full flex-col lg:flex-row justify-between items-center gap-10 ">
						...
						<div className="w-full lg:w-[638px] px-[20px] lg:px-0">
							<ul className="hidden lg:block mt-6 space-y-[21px]">
							...
							<ul className="block lg:hidden mt-6 space-y-4">
								{checklist.slice(0, 3).map((item, index) => (
									<li key={index} className="flex items-start gap-[23px]">
										...
										/>
										<span className="text-[14px] uppercase font-actor font-[400]">
											{item}
										</span>
									</li>
								))}
						...
						<div className="relative lg:w-[1073px] lg:h-[715px]  w-full h-full  lg:top-0 top-[-70px] overflow-hidden flex justify-center items-center  ">
							...
							<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
								<Button
									className="lg:w-[219px] lg:h-[50px] "
				...
				{/* Bottom Buttons */}
				<div className="  lg:pt-[15px]   z-40 flex lg:flex-row flex-col justify-center items-center gap-[14px]  ">
			...
			<div className="lg:pt-[95px] pt-[60px]">
				<div className="flex items-center justify-center gap-6">
					<div className="relative  rounded-2xl p-[2px] bg-transparent overflow-hidden">
						...
						{/* Main Inner Content */}
						<div className="relative z-10  w-[335px] md:w-[1078px] md:h-[148px] h-[108px]  bg-[rgba(13,13,13,1)] rounded-2xl px-[20px]  flex items-center justify-center text-white text-center">
							{/* Inner glow top-left */}
